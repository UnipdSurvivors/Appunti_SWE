...
\item [Sprint] Si scelgono ed eseguonole fasi ritenute più utili al creare un "incremento utile", dura dalle 2 alle 4 settimane e si ottiene un prodotto potenzialmente vendibile
\item [Sprint Backlog] Essenzialmente una todo list che raccoglie l'insiemen di storie per il prossimo sprint
\end{description}}
